...
// This intent is what begins the conversation  when you call to the skill. When you call to the conversation this is what Alexa will ask.       
    'list_states': function () {
     let list = "";
      ...
      this.emit(':responseReady');},
// This above intent is what a user can call for if they want a list of the states. The loop takes all the states in the array and will print them out together.       
